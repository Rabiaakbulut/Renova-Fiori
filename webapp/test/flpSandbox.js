			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"crudodata-display": {
								"semanticObject": "crudodata",
								"action": "display",
								"description": "oadata crud egitimi video1-3",
								"title": "odata egitim",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=crudodata",
									"url": sap.ui.require.toUrl("crudodata")
								}
							}
						}
					}
